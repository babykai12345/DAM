...
load './name.mat'
X1 = csvread('../02 JDSNMF/train_x_meth_noname_re.csv');

W = csvread('../02 JDSNMF/U_meth.csv');
H1 = csvread('../02 JDSNMF/H_meth.csv');
...
tt0 = 2; tt1 = 2;
[Co_module,Co_module_index,Co_module_classification,Co_module_name,score] =Comodule_selection_meth(X1, W, H1, tt0, tt1);
save Comodule_final_meth.mat Co_module;
