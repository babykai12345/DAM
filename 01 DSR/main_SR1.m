...
% label = csvread('E:\\旧电脑资料\\研究所\\final2\train_y_gene_noname.csv');
label = [ones(77,1); zeros(77,1)];
...
NN1=[512 512 512 512 512 512 512 512 512 449]; 
%  Architecture (hidden layer sizes)  for brain network phenotypes data neural network.
NN2=[512 512 512 512 512 512 512 512 512 856];
...
% csvwrite('E:\\旧电脑资料\\研究所\\final2\test_x_gene_noname_re.csv', sSNPdata)
% csvwrite('E:\\旧电脑资料\\研究所\\final2\test_x_meth_noname_re.csv', sBNdata)
% save 'E:\\旧电脑资料\\研究所\\final2\dataset_test.mat'
